...
def download_file(base_path, file_name, date_range=None, folder=None):
  ...
  save_path = get_destination_dir(file_name, folder) # modified version
  # save_path = get_destination_dir(os.path.join(base_path, file_name), folder) original Binance version
